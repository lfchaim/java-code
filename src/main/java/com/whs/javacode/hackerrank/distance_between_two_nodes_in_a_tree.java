...
public class distance_between_two_nodes_in_a_tree {
	public static  Node root;
	public distance_between_two_nodes_in_a_tree(){
		this.root = null;
	}
	...
	public static int bstDistance(int[] values, int n, int node1, int node2) {
		int ans = 0;
			distance_between_two_nodes_in_a_tree b = new distance_between_two_nodes_in_a_tree();
			for(int i =0;i<n;i++)
			{
				b.insert(values[i]);
			}
